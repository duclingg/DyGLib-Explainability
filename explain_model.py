...
if __name__ == "__main__":
    ...
    if args.prediction_type == "link":
        ...
        logger.info(f"Data loaded: {num_interactions} interactions, {num_unique_nodes} unique nodes")
        ...
        if args.explainer_type == "all":
            ...
            logger.warning("'all' explainer type not yet implemented. Running Shapley only.")
        ...
        if args.explainer_type == "shapley":
            ...
            raise NotImplementedError(f"Explainer type '{args.explainer_type}' is not yet implemented.")
        ...
        raise NotImplementedError("Node classification explanation is not yet implemented.")
